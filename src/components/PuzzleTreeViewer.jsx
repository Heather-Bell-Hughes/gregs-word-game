    ...
    <div className={styles.container}>
      <div className={styles.dagView}>
        <div className={styles.scrollArea}>
          ...
          <p className={styles.subtitle}>Build a new puzzle from the bottom up and submit it to be added to the game.<br />See open submissions <a className={styles.subtitleLink} href="https://docs.google.com/spreadsheets/d/1gPJKU-mlP6L_JljXvJFwxGOXSmJOpklTblGG1jfTq08/edit?gid=1881712769" target="_blank" rel="noreferrer">here</a>.</p>
          {navPath.length > 0 && (
