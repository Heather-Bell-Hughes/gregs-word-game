...
`).map(e=>e.trim().toUpperCase()).filter(e=>e.length>0)),C}function te(e){return w().has(e.toUpperCase())}function ne(e,t){return e.padEnd(t,`_`).slice(0,t).split(``)}function T(e){let t=e.join(``);return t.replace(/_/g,``)?(t.startsWith(`_`)||/_[A-Z]/.test(t),t.replace(/_+$/,``)):``}function re(e,t,n,r){let i=ne(e,t);return i[n]=r,T(i)}function ie(e,t,n){let r=ne(e,t),i=n;if(i===null){for(let e=t-1;e>=0;e--)if(r[e]!==`_`){i=e;break}if(i===null)return e}return i<0||i>=t||r[i]===`_`?e:(r[i]=`_`,T(r))}function ae(e,t){return ne(e,t).indexOf(`_`)}function oe(e,t){return ne(e,t).every(e=>e!==`_`)}var se=[5,4,3,2,1];function ce(e,t,n=null,r=null){let i=new Set(t.split(``));for(let t of se){let a=ne(e[t]||``,t);for(let e=0;e<t;e++){let o=a[e];o!==`_`&&(t===n&&e===r||i.add(o))}}return i}var le=[[`Q`,`W`,`E`,`R`,`T`,`Y`,`U`,`I`,`O`,`P`],[`A`,`S`,`D`,`F`,`G`,`H`,`J`,`K`,`L`],[`Z`,`X`,`C`,`V`,`B`,`N`,`M`,`DEL`]];function E({puzzle:e,puzzleIndex:t,onSolved:n,onGaveUp:r,onNextPuzzle:i,totalPuzzles:a}){let[o,s]=(0,_.useState)({5:``,4:``,3:``,2:``,1:``}),[c,l]=(0,_.useState)(5),[u,d]=(0,_.useState)(null),f=e.sixLetter,[p,m]=(0,_.useState)(``),[h,g]=(0,_.useState)(!1),[v,y]=(0,_.useState)({}),[b,ee]=(0,_.useState)(!1),[S,C]=(0,_.useState)(!1),w=(0,_.useRef)(5),T=(0,_.useRef)(null),E=(0,_.useRef)({5:``,4:``,3:``,2:``,1:``});(0,_.useEffect)(()=>{w.current=c},[c]),(0,_.useEffect)(()=>{T.current=u},[u]),(0,_.useEffect)(()=>{E.current=o},[o]);let D=(0,_.useCallback)((e,t)=>{if(!oe(t,e)||!te(t.replace(/_/g,``)))return;let n=se.indexOf(e);if(n>=se.length-1)return;let r=se[n+1];w.current=r,T.current=0,l(r),d(0)},[]),ue=(0,_.useCallback)(()=>{let e=w.current,t=E.current[e],n=T.current;if(n===null&&oe(t,e)&&te(t.replace(/_/g,``))){let r=se.indexOf(e);r<se.length-1&&(e=se[r+1],t=E.current[e],n=0)}return{wordSize:e,word:t,boxIndex:n}},[]),de=(0,_.useCallback)((e,t)=>{if(oe(t,e)){let n=te(t.replace(/_/g,``));y(r=>({...r,[e]:ne(t,e).map(()=>n?`correct`:`wrong`)}))}else y(t=>({...t,[e]:[]}))},[]),fe=(0,_.useMemo)(()=>ce(o,f,u===null?null:c,u),[o,f,c,u]),pe=(0,_.useCallback)(e=>{let{wordSize:t,word:n,boxIndex:r}=ue();if(ce(E.current,f,r===null?null:t,r).has(e))return;t!==w.current&&(w.current=t,T.current=r??0,l(t),d(r??0));let i=ne(n,t);if(r!==null&&r<t&&i[r]===e){let e=r+1;e<t&&(T.current=e,d(e));return}let a=null;if(r!==null&&r<t){a=re(n,t,r,e),s(e=>({...e,[t]:a}));let i=r+1;i<t&&(T.current=i,d(i))}else{let r=ae(n,t);r!==-1&&(a=re(n,t,r,e),s(e=>({...e,[t]:a})))}a!==null&&(de(t,a),D(t,a))},[f,ue,D,de]),O=(0,_.useCallback)(e=>{pe(e)},[pe]),k=(0,_.useCallback)((e,t)=>{w.current=e,T.current=t,l(e),d(t)},[]),me=(e,t)=>{k(e,t)},he=e=>{let t=E.current[e];if(w.current=e,l(e),t.replace(/_/g,``).length===0)T.current=0,d(0);else{let n=ne(t,e).findLastIndex(e=>e!==`_`);n===-1&&(n=0),T.current=n,d(n)}},ge=(0,_.useCallback)((e,t)=>{let n=E.current[e],r=ne(n,e),i=t;if(i===null&&(i=r.findLastIndex(e=>e!==`_`),i===-1&&(i=0)),r[i]!==`_`){let t=ie(n,e,i);t!==n&&(s(n=>({...n,[e]:t})),de(e,t))}k(e,Math.max(0,i-1))},[de,k]),_e=(0,_.useCallback)(e=>{let t=w.current,n=T.current,r=E.current[t],i=ne(r,t);n=n===null?e===`left`?i.findLastIndex(e=>e!==`_`)===-1?0:i.findLastIndex(e=>e!==`_`):0:e===`left`?Math.max(0,n-1):Math.min(t-1,n+1),k(t,n)},[k]),ve=(0,_.useCallback)(()=>{ge(w.current,T.current)},[ge]);(0,_.useEffect)(()=>{let e=e=>{if(e.ctrlKey||e.metaKey)return;let t=e.key.toUpperCase();/^[A-Z]$/.test(t)?(e.preventDefault(),pe(t)):e.key===`ArrowLeft`?(e.preventDefault(),_e(`left`)):e.key===`ArrowRight`?(e.preventDefault(),_e(`right`)):e.key===`Backspace`&&(e.preventDefault(),ge(w.current,T.current))};return document.addEventListener(`keydown`,e),()=>document.removeEventListener(`keydown`,e)},[pe,ge,_e]),(0,_.useEffect)(()=>{let r=!0,i=!0,a={};for(let e of[5,4,3,2,1]){let t=o[e],n=t.replace(/_/g,``);if(a[e]=[],oe(t,e)||(r=!1),oe(t,e)){let t=te(n);for(let n=0;n<e;n++)a[e][n]=t?`correct`:`wrong`;t||(i=!1)}}y(a),r&&i&&!S&&!b&&(C(!0),m(`🎉 Congratulations, Well Done!`),window.gtag?.(`event`,`puzzle_solved`,{puzzle_index:t,puzzle_word:e.sixLetter}),n())},[o,S,b,n]);let ye=()=>{ee(!0),s({5:e.fiveLetters,4:e.fourLetters,3:e.threeLetters,2:e.twoLetters,1:e.oneLetter});let n={};for(let e of[5,4,3,2,1])n[e]=Array(e).fill(`correct`);y(n),window.gtag?.(`event`,`puzzle_gave_up`,{puzzle_index:t,puzzle_word:e.sixLetter}),r()},be=()=>{s({5:``,4:``,3:``,2:``,1:``}),m(``),y({}),l(5),d(0),ee(!1),C(!1)};return(0,x.jsxs)(`div`,{className:`container`,"data-testid":`game-screen`,children:[p&&(0,x.jsx)(`div`,{className:`message ${p.includes(`✓`)||p.includes(`🎉`)?`success`:`error`}`,children:p}),(0,x.jsxs)(`div`,{className:`header`,children:[(0,x.jsx)(`div`,{className:`header-spacer`,"aria-hidden":`true`}),(0,x.jsxs)(`div`,{className:`puzzle-title`,children:[`AlphaDelta #`,t+1]}),(0,x.jsx)(`button`,{className:`info-btn`,onClick:()=>g(!h),children:`?`})]}),h&&(0,x.jsx)(`div`,{className:`rules-modal`,children:(0,x.jsxs)(`div`,{className:`rules-content`,children:[(0,x.jsx)(`h2`,{children:`How to Play`}),(0,x.jsx)(`p`,{children:`When the game starts, a 6-letter word will appear from an A-Z alphabet. Using the remaining letters of the alphabet, make a 5-letter word, a 4-letter word, a 3-letter word, a 2-letter word & a 1-letter word in the boxes. Each alphabet letter can only be used once. All valid words are regular everyday english words.`}),(0,x.jsx)(`button`,{className:`btn`,onClick:()=>g(!1),children:`Close`})]})}),(0,x.jsxs)(`div`,{className:`buttons-row`,children:[b||S?(0,x.jsx)(`button`,{className:`btn reveal`,onClick:i,children:`New Game`}):(0,x.jsx)(`button`,{className:`btn reveal`,onClick:ye,children:`Solution`}),!S&&!b&&(0,x.jsx)(`button`,{className:`btn`,"data-testid":`clear-btn`,onClick:()=>{s(e=>({...e,[c]:``})),y(e=>({...e,[c]:[]})),T.current=0,d(0)},children:`Clear`}),!S&&!b&&(0,x.jsx)(`button`,{className:`btn restart`,"data-testid":`restart-btn`,onClick:()=>{confirm(`Are you sure you want to restart the puzzle?`)&&be()},children:`Restart`})]}),(0,x.jsxs)(`div`,{className:`puzzle-area`,children:[(0,x.jsxs)(`div`,{className:`word-boxes-container`,children:[(0,x.jsx)(`div`,{className:`word-row six-letter-row`,"data-testid":`six-letter-row`,children:e.sixLetter.split(``).map((e,t)=>(0,x.jsx)(`div`,{className:`letter-box`,children:e},t))}),[5,4,3,2,1].map(e=>{let t=ne(o[e],e);return(0,x.jsx)(`div`,{className:`word-row`,"data-word-size":e,"data-testid":`word-row-${e}`,onClick:()=>he(e),children:t.map((t,n)=>(0,x.jsx)(`button`,{type:`button`,"data-testid":`word-box-${e}-${n}`,"aria-label":`${e}-letter word, position ${n+1}${t===`_`?`, empty`:`, letter ${t}`}${c===e&&u===n?`, selected`:``}`,className:`word-box ${t===`_`?`empty`:`filled`} ${c===e&&u===n?`focused`:c===e?`selected`:``} ${v[e]?.[n]?v[e][n]:``}`,onClick:t=>{t.stopPropagation(),me(e,n)},onTouchEnd:t=>{t.stopPropagation(),t.preventDefault(),me(e,n)},children:t===`_`?``:t},n))},e)})]}),(0,x.jsx)(`div`,{className:`keyboard-container`,"data-testid":`keyboard`,children:le.map((e,t)=>(0,x.jsx)(`div`,{className:`keyboard-row`,children:e.map((e,t)=>e===``?(0,x.jsx)(`div`,{className:`keyboard-spacer`},t):e===`DEL`?(0,x.jsx)(`button`,{type:`button`,"data-testid":`keyboard-delete`,className:`keyboard-key delete-key`,onClick:ve,onTouchEnd:e=>{e.preventDefault(),ve()},children:`⌫`},e):(0,x.jsx)(`button`,{type:`button`,"data-testid":`keyboard-key-${e}`,className:`keyboard-key ${fe.has(e)?`used`:``}`,onClick:()=>O(e),onTouchEnd:t=>{t.preventDefault(),O(e)},children:e},e))},t))})]})]})}var D={container:`_container_k7fnq_1`,title:`_title_k7fnq_12`,subtitle:`_subtitle_k7fnq_18`,error:`_error_k7fnq_24`,toolbar:`_toolbar_k7fnq_27`,viewToggle:`_viewToggle_k7fnq_35`,toggleActive:`_toggleActive_k7fnq_42`,toggleInactive:`_toggleInactive_k7fnq_52`,toolbarCount:`_toolbarCount_k7fnq_65`,dagView:`_dagView_k7fnq_68`,scrollArea:`_scrollArea_k7fnq_79`,bottomBar:`_bottomBar_k7fnq_86`,bottomSpacer:`_bottomSpacer_k7fnq_96`,legendDot:`_legendDot_k7fnq_97`,legendText:`_legendText_k7fnq_98`,legendSep:`_legendSep_k7fnq_99`,pathStack:`_pathStack_k7fnq_102`,pathWord:`_pathWord_k7fnq_110`,pathWordFinal:`_pathWordFinal_k7fnq_126`,pathComplete:`_pathComplete_k7fnq_134`,pathCompleteTitle:`_pathCompleteTitle_k7fnq_143`,pathCompleteNum:`_pathCompleteNum_k7fnq_144`,pathCompleteSub:`_pathCompleteSub_k7fnq_145`,subtitleLink:`_subtitleLink_k7fnq_147`,sheetLink:`_sheetLink_k7fnq_153`,nearDupWarning:`_nearDupWarning_k7fnq_160`,addPuzzleBtn:`_addPuzzleBtn_k7fnq_171`,hardToggle:`_hardToggle_k7fnq_184`,confirmButtons:`_confirmButtons_k7fnq_193`,confirmYes:`_confirmYes_k7fnq_198`,confirmNo:`_confirmNo_k7fnq_209`,levelHeader:`_levelHeader_k7fnq_222`,levelLabel:`_levelLabel_k7fnq_230`,loadingLabel:`_loadingLabel_k7fnq_231`,bottomNav:`_bottomNav_k7fnq_234`,resetBtn:`_resetBtn_k7fnq_240`,levelTitle:`_levelTitle_k7fnq_253`,nodes:`_nodes_k7fnq_263`,node:`_node_k7fnq_263`,nodeUnpuzzled:`_nodeUnpuzzled_k7fnq_287`,nodePuzzled:`_nodePuzzled_k7fnq_288`,terminalNode:`_terminalNode_k7fnq_292`,childCount:`_childCount_k7fnq_295`,depthBadge:`_depthBadge_k7fnq_303`,backButton:`_backButton_k7fnq_313`,stats:`_stats_k7fnq_325`,treeViewport:`_treeViewport_k7fnq_338`,treeRoot:`_treeRoot_k7fnq_344`,treeItem:`_treeItem_k7fnq_354`,treeChildren:`_treeChildren_k7fnq_398`,treeNodeBox:`_treeNodeBox_k7fnq_420`,treeExpandedBox:`_treeExpandedBox_k7fnq_445`,treeTerminalBox:`_treeTerminalBox_k7fnq_451`,treeWord:`_treeWord_k7fnq_465`,puzzleBadge:`_puzzleBadge_k7fnq_470`},ue=new Map(y.map((e,t)=>[e.sixLetter,t+1])),de=`/AlphaDelta/`.replace(/\/$/,``);async function fe(e){let t=e.length?e.join(`/`)+`/`:``,n=await fetch(`${de}/puzzle-tree/${t}index.json`);if(!n.ok)throw Error(`${n.status} loading ${t}index.json`);return n.json()}function pe(e,t,n){if(t.length===0)return{...e,...n};let[r,...i]=t;return{...e,children:{...e.children??{},[r]:pe(e.children?.[r]??{},i,n)}}}function O(e,t){let n=e;for(let e of t){if(!n?.children?.[e])return null;n=n.children[e]}return n}function k(e){let t=e=>e.endsWith(`S`)?e.slice(0,-1):e,[n,r,i,a,o,s]=e,c=new Set([t(o),t(s)]);return y.find((e,o)=>{if(e.oneLetter!==n||e.twoLetters!==r||e.threeLetters!==i||e.fourLetters!==a||e.sixLetter===s)return!1;let l=new Set([t(e.fiveLetters),t(e.sixLetter)]);return c.size===l.size&&[...c].every(e=>l.has(e))})}var me=`https://docs.google.com/spreadsheets/d/1gPJKU-mlP6L_JljXvJFwxGOXSmJOpklTblGG1jfTq08/export?format=csv&gid=1881712769`,he=`https://docs.google.com/forms/d/e/1FAIpQLScZGMw_adTq13FTOR21Tx46wy4LPZczpzsxQYoXhSNP3FRpAA/formResponse`,ge={6:`entry.286261207`,5:`entry.48461877`,4:`entry.1189278412`,3:`entry.215585409`,2:`entry.973779032`,1:`entry.1514953076`},_e=`entry.2024642100`;async function ve(e,t){let n=new URLSearchParams;e.forEach(e=>n.append(ge[e.length],e)),t&&n.append(_e,`Hard`),await fetch(he,{method:`POST`,mode:`no-cors`,body:n})}function ye(){let[e,t]=(0,_.useState)(null),[n,r]=(0,_.useState)([]),[i,a]=(0,_.useState)(!0),[o,s]=(0,_.useState)(null),[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)(!1),[f,p]=(0,_.useState)(0),[m,h]=(0,_.useState)(!1),[g,v]=(0,_.useState)(null);(0,_.useEffect)(()=>{fe([]).then(e=>{t(e),a(!1)}).catch(e=>{s(e.message),a(!1)})},[]),(0,_.useEffect)(()=>{n.length===6&&window.gtag?.(`event`,`tree_path_completed`,{puzzle_word:n[5],already_puzzle:!!ue.get(n[5])})},[n]),(0,_.useEffect)(()=>{fetch(me).then(e=>e.text()).then(e=>{v(new Set(e.trim().split(`
`).slice(1).map(e=>e.split(`,`)[1]?.replace(/"/g,``).trim().toUpperCase()).filter(Boolean)))}).catch(()=>v(new Set))},[]);async function b(i,o=!1){let c=[...n,i];if(l(!1),d(!1),o){r(c);return}if(O(e,c)?.children!==void 0){r(c);return}a(!0);try{let e=await fe(c);t(t=>pe(t,c,e)),r(c)}catch(e){s(e.message)}finally{a(!1)}}if(!e&&i)return(0,x.jsx)(`div`,{className:D.container,children:(0,x.jsx)(`p`,{children:`Loading puzzle tree…`})});if(o)return(0,x.jsx)(`div`,{className:D.container,children:(0,x.jsx)(`p`,{className:D.error,children:o})});let ee=(O(e,n)??e)?.children??{},S=Object.entries(ee).filter(([e,t])=>e.length+t.maxDepth>=6).sort(([e],[t])=>e.localeCompare(t));return(0,x.jsx)(`div`,{className:D.container,children:(0,x.jsxs)(`div`,{className:D.dagView,children:[(0,x.jsxs)(`div`,{className:D.scrollArea,children:[(0,x.jsx)(`h1`,{className:D.title,children:`Puzzle Tree`}),(0,x.jsxs)(`p`,{className:D.subtitle,children:[`Build a new puzzle from the bottom up and submit it to be added to the game.`,(0,x.jsx)(`br`,{}),`See open submissions `,(0,x.jsx)(`a`,{className:D.subtitleLink,href:`https://docs.google.com/spreadsheets/d/1gPJKU-mlP6L_JljXvJFwxGOXSmJOpklTblGG1jfTq08/edit?gid=1881712769`,target:`_blank`,rel:`noreferrer`,children:`here`}),`.`]}),n.length>0&&(0,x.jsx)(`div`,{className:D.pathStack,children:[...n].reverse().map((e,t)=>{let i=n.length-1-t,a=e.length===6;return(0,x.jsx)(`button`,{className:`${D.pathWord} ${a?D.pathWordFinal:``}`,onClick:()=>r(n.slice(0,i+1)),children:e},e)})}),n.length<6&&(0,x.jsxs)(`div`,{className:D.levelHeader,children:[(0,x.jsxs)(`span`,{className:D.levelLabel,children:[n.length+1,`-letter words`]}),i&&(0,x.jsx)(`span`,{className:D.loadingLabel,children:`Loading…`})]}),n.length===6?(0,x.jsx)(`div`,{className:D.pathComplete,children:ue.get(n[5])?(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{className:D.pathCompleteTitle,children:`Already a puzzle`}),(0,x.jsxs)(`div`,{className:D.pathCompleteNum,children:[`Puzzle #`,ue.get(n[5])]})]}):g?.has(n[5])?(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{className:D.pathCompleteTitle,children:`Already queued`}),(0,x.jsx)(`div`,{className:D.pathCompleteSub,children:`This puzzle has been submitted and will be added on the next import run`}),(0,x.jsx)(`a`,{className:D.sheetLink,href:`https://docs.google.com/spreadsheets/d/1gPJKU-mlP6L_JljXvJFwxGOXSmJOpklTblGG1jfTq08/edit?gid=1881712769`,target:`_blank`,rel:`noreferrer`,children:`View queue`})]}):u?(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{className:D.pathCompleteTitle,children:`Submitted!`}),(0,x.jsxs)(`div`,{className:D.pathCompleteSub,children:[`It'll be Puzzle #`,y.length+f,` — live on the next import run`]}),(0,x.jsx)(`a`,{className:D.sheetLink,href:`https://docs.google.com/spreadsheets/d/1gPJKU-mlP6L_JljXvJFwxGOXSmJOpklTblGG1jfTq08/edit?gid=1881712769`,target:`_blank`,rel:`noreferrer`,children:`View queue`})]}):c?(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{className:D.pathCompleteTitle,children:`Add this puzzle?`}),(0,x.jsx)(`div`,{className:D.pathCompleteSub,children:n.join(` → `)}),(0,x.jsxs)(`label`,{className:D.hardToggle,children:[(0,x.jsx)(`input`,{type:`checkbox`,checked:m,onChange:e=>h(e.target.checked)}),`Mark as hard`]}),(0,x.jsxs)(`div`,{className:D.confirmButtons,children:[(0,x.jsx)(`button`,{className:D.confirmYes,onClick:async()=>{await ve(n,m),window.gtag?.(`event`,`puzzle_submitted`,{puzzle_word:n[5],difficulty:m?`hard`:`normal`}),p(e=>e+1),l(!1),d(!0),h(!1)},children:`Yes, add it`}),(0,x.jsx)(`button`,{className:D.confirmNo,onClick:()=>{l(!1),h(!1)},children:`Cancel`})]})]}):(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{className:D.pathCompleteTitle,children:`New puzzle candidate`}),(0,x.jsx)(`div`,{className:D.pathCompleteSub,children:n.join(` → `)}),(()=>{let e=k(n);if(!e)return null;let t=ue.get(e.sixLetter);return(0,x.jsxs)(`div`,{className:D.nearDupWarning,children:[`⚠ Similar to Puzzle #`,t,` — same puzzle with `,e.sixLetter,`/`,e.fiveLetters,` swapped to `,n[5],`/`,n[4]]})})(),(0,x.jsx)(`button`,{className:D.addPuzzleBtn,onClick:()=>l(!0),children:`Add Puzzle`})]})}):(0,x.jsx)(`div`,{className:D.nodes,children:S.map(([e,t])=>{let n=t.maxDepth===0,r=ue.get(e),i=n?!!r:!t.hasUnpuzzled;return(0,x.jsxs)(`div`,{className:`${D.node} ${n?D.terminalNode:``} ${i?D.nodePuzzled:D.nodeUnpuzzled}`,onClick:()=>b(e,n),children:[(0,x.jsx)(`span`,{children:e}),n&&(0,x.jsx)(`div`,{className:D.depthBadge,children:`end`}),!n&&t.childCount!==void 0&&(0,x.jsx)(`div`,{className:D.childCount,children:t.childCount}),r&&(0,x.jsxs)(`div`,{className:D.puzzleBadge,children:[`Puzzle #`,r]})]},e)})})]}),(0,x.jsxs)(`div`,{className:D.bottomBar,children:[n.length>0&&(0,x.jsx)(`button`,{className:D.backButton,onClick:()=>r(e=>e.slice(0,-1)),children:`← Back`}),n.length>1&&(0,x.jsx)(`button`,{className:D.resetBtn,onClick:()=>r([]),children:`Reset`}),(0,x.jsx)(`span`,{className:D.bottomSpacer}),(0,x.jsx)(`span`,{className:D.legendDot,style:{background:`#81c784`}}),(0,x.jsx)(`span`,{className:D.legendText,children:`unpuzzled`}),(0,x.jsx)(`span`,{className:D.legendSep}),(0,x.jsx)(`span`,{className:D.legendDot,style:{background:`#ffb347`}}),(0,x.jsx)(`span`,{className:D.legendText,children:`puzzled`})]})]})})}var be=Date.UTC(2024,0,1);function xe(){return`/AlphaDelta/`}function Se(e){let t=new Date,n=Date.UTC(t.getUTCFullYear(),t.getUTCMonth(),t.getUTCDate());return(Math.floor((n-be)/864e5)%e+e)%e}function Ce(e,t=xe()){let n=t.replace(/\/$/,``);if(n&&n!==``&&e.startsWith(n)){let t=e.slice(n.length);return t.startsWith(`/`)?t:`/${t}`}return e}function we(e,t=xe()){let n=Ce(e,t);return n===`/menu`||n===`/menu/`}function Te(e,t,n=xe()){let r=Ce(e,n);if(we(e,n)||r===`/`||r===``)return Se(t);let i=r.match(/^\/(\d+)\/?$/);if(i){let e=parseInt(i[1],10);return Math.min(Math.max(e-1,0),t-1)}return Se(t)}function Ee(e,t=xe()){return`${t}${e+1}`.replace(/([^:]\/)\/+/g,`$1`)}function De(e){let t=Ee(e);window.history.pushState({puzzleIndex:e},``,t)}function Oe(e,t=xe()){let n=Ce(e,t);return n===`/tree`||n===`/tree/`}function ke(){let[e,t]=(0,_.useState)(()=>we(window.location.pathname)),[n,r]=(0,_.useState)(()=>Oe(window.location.pathname)),[i,a]=(0,_.useState)(()=>Te(window.location.pathname,y.length)),[o,s]=(0,_.useState)(()=>{let e=localStorage.getItem(`wordGameStats`),t=e?JSON.parse(e):[];return y.map((e,n)=>t[n]||{id:n,status:`unsolved`,attempts:0,solved:!1})});(0,_.useEffect)(()=>{localStorage.setItem(`wordGameStats`,JSON.stringify(o))},[o]),(0,_.useEffect)(()=>{let e=()=>{t(we(window.location.pathname)),r(Oe(window.location.pathname)),a(Te(window.location.pathname,y.length))};return window.addEventListener(`popstate`,e),()=>window.removeEventListener(`popstate`,e)},[]),(0,_.useEffect)(()=>{n?window.gtag?.(`event`,`page_view`,{page_title:`Puzzle Tree`,page_path:`/tree`}):e?window.gtag?.(`event`,`page_view`,{page_title:`Menu`,page_path:`/menu`}):window.gtag?.(`event`,`page_view`,{page_title:`Puzzle #${i+1}`,page_path:`/puzzle/${i+1}`})},[n,e,i]);let c=(0,_.useCallback)(e=>{let n=Math.min(Math.max(e,0),y.length-1);De(n),t(!1),a(n),window.gtag?.(`event`,`puzzle_selected`,{puzzle_index:n+1,puzzle_word:y[n].sixLetter})},[]),l=()=>{c((i+1)%y.length)},u=()=>{s(e=>{let t=[...e];return t[i]={...t[i],status:`solved`,solved:!0,attempts:(t[i].attempts||0)+1},t})},d=()=>{s(e=>{let t=[...e];return t[i]={...t[i],status:`gaveup`,attempts:(t[i].attempts||0)+1},t})},f=o.filter(e=>e.solved).length,p=o.filter(e=>e.status===`gaveup`).length;return n?(0,x.jsx)(ye,{}):e?(0,x.jsx)(ee,{puzzles:y,stats:o,onSelectPuzzle:c,solvedCount:f,gaveUpCount:p}):(0,x.jsx)(E,{puzzle:y[i],puzzleIndex:i,onSolved:u,onGaveUp:d,onNextPuzzle:l,totalPuzzles:y.length},i)}v.createRoot(document.getElementById(`root`)).render((0,x.jsx)(_.StrictMode,{children:(0,x.jsx)(ke,{})}));