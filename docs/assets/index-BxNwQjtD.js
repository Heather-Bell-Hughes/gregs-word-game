...
`).map(e=>e.trim().toUpperCase()).filter(e=>e.length>0)),C}function ne(e){return te().has(e.toUpperCase())}function re(e,t){return e.padEnd(t,`_`).slice(0,t).split(``)}function w(e){let t=e.join(``);return t.replace(/_/g,``)?(t.startsWith(`_`)||/_[A-Z]/.test(t),t.replace(/_+$/,``)):``}function ie(e,t,n,r){let i=re(e,t);return i[n]=r,w(i)}function ae(e,t,n){let r=re(e,t),i=n;if(i===null){for(let e=t-1;e>=0;e--)if(r[e]!==`_`){i=e;break}if(i===null)return e}return i<0||i>=t||r[i]===`_`?e:(r[i]=`_`,w(r))}function oe(e,t){return re(e,t).indexOf(`_`)}function se(e,t){return re(e,t).every(e=>e!==`_`)}var ce=[5,4,3,2,1];function le(e,t,n=null,r=null){let i=new Set(t.split(``));for(let t of ce){let a=re(e[t]||``,t);for(let e=0;e<t;e++){let o=a[e];o!==`_`&&(t===n&&e===r||i.add(o))}}return i}var ue=[[`Q`,`W`,`E`,`R`,`T`,`Y`,`U`,`I`,`O`,`P`],[`A`,`S`,`D`,`F`,`G`,`H`,`J`,`K`,`L`],[`Z`,`X`,`C`,`V`,`B`,`N`,`M`,`DEL`]];function T({puzzle:e,puzzleIndex:t,onSolved:n,onGaveUp:r,onNextPuzzle:i,totalPuzzles:a}){let[o,s]=(0,_.useState)({5:``,4:``,3:``,2:``,1:``}),[c,l]=(0,_.useState)(5),[u,d]=(0,_.useState)(null),f=e.sixLetter,[p,m]=(0,_.useState)(``),[h,g]=(0,_.useState)(!1),[v,y]=(0,_.useState)({}),[b,ee]=(0,_.useState)(!1),[S,C]=(0,_.useState)(!1),te=(0,_.useRef)(5),w=(0,_.useRef)(null),T=(0,_.useRef)({5:``,4:``,3:``,2:``,1:``});(0,_.useEffect)(()=>{te.current=c},[c]),(0,_.useEffect)(()=>{w.current=u},[u]),(0,_.useEffect)(()=>{T.current=o},[o]);let E=(0,_.useCallback)((e,t)=>{if(!se(t,e)||!ne(t.replace(/_/g,``)))return;let n=ce.indexOf(e);if(n>=ce.length-1)return;let r=ce[n+1];te.current=r,w.current=0,l(r),d(0)},[]),de=(0,_.useCallback)(()=>{let e=te.current,t=T.current[e],n=w.current;if(n===null&&se(t,e)&&ne(t.replace(/_/g,``))){let r=ce.indexOf(e);r<ce.length-1&&(e=ce[r+1],t=T.current[e],n=0)}return{wordSize:e,word:t,boxIndex:n}},[]),fe=(0,_.useCallback)((e,t)=>{if(se(t,e)){let n=ne(t.replace(/_/g,``));y(r=>({...r,[e]:re(t,e).map(()=>n?`correct`:`wrong`)}))}else y(t=>({...t,[e]:[]}))},[]),pe=(0,_.useMemo)(()=>le(o,f,u===null?null:c,u),[o,f,c,u]),me=(0,_.useCallback)(e=>{let{wordSize:t,word:n,boxIndex:r}=de();if(le(T.current,f,r===null?null:t,r).has(e))return;t!==te.current&&(te.current=t,w.current=r??0,l(t),d(r??0));let i=re(n,t);if(r!==null&&r<t&&i[r]===e){let e=r+1;e<t&&(w.current=e,d(e));return}let a=null;if(r!==null&&r<t){a=ie(n,t,r,e),s(e=>({...e,[t]:a}));let i=r+1;i<t&&(w.current=i,d(i))}else{let r=oe(n,t);r!==-1&&(a=ie(n,t,r,e),s(e=>({...e,[t]:a})))}a!==null&&(fe(t,a),E(t,a))},[f,de,E,fe]),D=(0,_.useCallback)(e=>{me(e)},[me]),O=(0,_.useCallback)((e,t)=>{te.current=e,w.current=t,l(e),d(t)},[]),he=(e,t)=>{O(e,t)},ge=e=>{let t=T.current[e];if(te.current=e,l(e),t.replace(/_/g,``).length===0)w.current=0,d(0);else{let n=re(t,e).findLastIndex(e=>e!==`_`);n===-1&&(n=0),w.current=n,d(n)}},_e=(0,_.useCallback)((e,t)=>{let n=T.current[e],r=re(n,e),i=t;if(i===null&&(i=r.findLastIndex(e=>e!==`_`),i===-1&&(i=0)),r[i]!==`_`){let t=ae(n,e,i);t!==n&&(s(n=>({...n,[e]:t})),fe(e,t))}O(e,Math.max(0,i-1))},[fe,O]),ve=(0,_.useCallback)(e=>{let t=te.current,n=w.current,r=T.current[t],i=re(r,t);n=n===null?e===`left`?i.findLastIndex(e=>e!==`_`)===-1?0:i.findLastIndex(e=>e!==`_`):0:e===`left`?Math.max(0,n-1):Math.min(t-1,n+1),O(t,n)},[O]),ye=(0,_.useCallback)(()=>{_e(te.current,w.current)},[_e]);(0,_.useEffect)(()=>{let e=e=>{if(e.ctrlKey||e.metaKey)return;let t=e.key.toUpperCase();/^[A-Z]$/.test(t)?(e.preventDefault(),me(t)):e.key===`ArrowLeft`?(e.preventDefault(),ve(`left`)):e.key===`ArrowRight`?(e.preventDefault(),ve(`right`)):e.key===`Backspace`&&(e.preventDefault(),_e(te.current,w.current))};return document.addEventListener(`keydown`,e),()=>document.removeEventListener(`keydown`,e)},[me,_e,ve]),(0,_.useEffect)(()=>{let r=!0,i=!0,a={};for(let e of[5,4,3,2,1]){let t=o[e],n=t.replace(/_/g,``);if(a[e]=[],se(t,e)||(r=!1),se(t,e)){let t=ne(n);for(let n=0;n<e;n++)a[e][n]=t?`correct`:`wrong`;t||(i=!1)}}y(a),r&&i&&!S&&!b&&(C(!0),m(`🎉 Congratulations, Well Done!`),window.gtag?.(`event`,`puzzle_solved`,{puzzle_index:t,puzzle_word:e.sixLetter}),n())},[o,S,b,n]);let be=()=>{ee(!0),s({5:e.fiveLetters,4:e.fourLetters,3:e.threeLetters,2:e.twoLetters,1:e.oneLetter});let n={};for(let e of[5,4,3,2,1])n[e]=Array(e).fill(`correct`);y(n),window.gtag?.(`event`,`puzzle_gave_up`,{puzzle_index:t,puzzle_word:e.sixLetter}),r()},xe=()=>{s({5:``,4:``,3:``,2:``,1:``}),m(``),y({}),l(5),d(0),ee(!1),C(!1)};return(0,x.jsxs)(`div`,{className:`container`,"data-testid":`game-screen`,children:[p&&(0,x.jsx)(`div`,{className:`message ${p.includes(`✓`)||p.includes(`🎉`)?`success`:`error`}`,children:p}),(0,x.jsxs)(`div`,{className:`header`,children:[(0,x.jsx)(`div`,{className:`header-spacer`,"aria-hidden":`true`}),(0,x.jsxs)(`div`,{className:`puzzle-title`,children:[`AlphaDelta #`,t+1]}),(0,x.jsx)(`button`,{className:`info-btn`,onClick:()=>g(!h),children:`?`})]}),h&&(0,x.jsx)(`div`,{className:`rules-modal`,children:(0,x.jsxs)(`div`,{className:`rules-content`,children:[(0,x.jsx)(`h2`,{children:`How to Play`}),(0,x.jsx)(`p`,{children:`When the game starts, a 6-letter word will appear from an A-Z alphabet. Using the remaining letters of the alphabet, make a 5-letter word, a 4-letter word, a 3-letter word, a 2-letter word & a 1-letter word in the boxes. Each alphabet letter can only be used once. All valid words are regular everyday english words.`}),(0,x.jsx)(`button`,{className:`btn`,onClick:()=>g(!1),children:`Close`})]})}),(0,x.jsxs)(`div`,{className:`buttons-row`,children:[b||S?(0,x.jsx)(`button`,{className:`btn reveal`,onClick:i,children:`New Game`}):(0,x.jsx)(`button`,{className:`btn reveal`,onClick:be,children:`Solution`}),!S&&!b&&(0,x.jsx)(`button`,{className:`btn`,"data-testid":`clear-btn`,onClick:()=>{s(e=>({...e,[c]:``})),y(e=>({...e,[c]:[]})),w.current=0,d(0)},children:`Clear`}),!S&&!b&&(0,x.jsx)(`button`,{className:`btn restart`,"data-testid":`restart-btn`,onClick:()=>{confirm(`Are you sure you want to restart the puzzle?`)&&xe()},children:`Restart`})]}),(0,x.jsxs)(`div`,{className:`puzzle-area`,children:[(0,x.jsxs)(`div`,{className:`word-boxes-container`,children:[(0,x.jsx)(`div`,{className:`word-row six-letter-row`,"data-testid":`six-letter-row`,children:e.sixLetter.split(``).map((e,t)=>(0,x.jsx)(`div`,{className:`letter-box`,children:e},t))}),[5,4,3,2,1].map(e=>{let t=re(o[e],e);return(0,x.jsx)(`div`,{className:`word-row`,"data-word-size":e,"data-testid":`word-row-${e}`,onClick:()=>ge(e),children:t.map((t,n)=>(0,x.jsx)(`button`,{type:`button`,"data-testid":`word-box-${e}-${n}`,"aria-label":`${e}-letter word, position ${n+1}${t===`_`?`, empty`:`, letter ${t}`}${c===e&&u===n?`, selected`:``}`,className:`word-box ${t===`_`?`empty`:`filled`} ${c===e&&u===n?`focused`:c===e?`selected`:``} ${v[e]?.[n]?v[e][n]:``}`,onClick:t=>{t.stopPropagation(),he(e,n)},onTouchEnd:t=>{t.stopPropagation(),t.preventDefault(),he(e,n)},children:t===`_`?``:t},n))},e)})]}),(0,x.jsx)(`div`,{className:`keyboard-container`,"data-testid":`keyboard`,children:ue.map((e,t)=>(0,x.jsx)(`div`,{className:`keyboard-row`,children:e.map((e,t)=>e===``?(0,x.jsx)(`div`,{className:`keyboard-spacer`},t):e===`DEL`?(0,x.jsx)(`button`,{type:`button`,"data-testid":`keyboard-delete`,className:`keyboard-key delete-key`,onClick:ye,onTouchEnd:e=>{e.preventDefault(),ye()},children:`⌫`},e):(0,x.jsx)(`button`,{type:`button`,"data-testid":`keyboard-key-${e}`,className:`keyboard-key ${pe.has(e)?`used`:``}`,onClick:()=>D(e),onTouchEnd:t=>{t.preventDefault(),D(e)},children:e},e))},t))})]})]})}var E={container:`_container_u0u8l_1`,title:`_title_u0u8l_12`,subtitle:`_subtitle_u0u8l_18`,error:`_error_u0u8l_24`,toolbar:`_toolbar_u0u8l_27`,viewToggle:`_viewToggle_u0u8l_35`,toggleActive:`_toggleActive_u0u8l_42`,toggleInactive:`_toggleInactive_u0u8l_52`,toolbarCount:`_toolbarCount_u0u8l_65`,dagView:`_dagView_u0u8l_68`,scrollArea:`_scrollArea_u0u8l_79`,bottomBar:`_bottomBar_u0u8l_86`,bottomSpacer:`_bottomSpacer_u0u8l_96`,legendDot:`_legendDot_u0u8l_97`,legendText:`_legendText_u0u8l_98`,legendSep:`_legendSep_u0u8l_99`,pathStack:`_pathStack_u0u8l_102`,pathWord:`_pathWord_u0u8l_110`,pathWordFinal:`_pathWordFinal_u0u8l_126`,pathComplete:`_pathComplete_u0u8l_134`,pathCompleteTitle:`_pathCompleteTitle_u0u8l_143`,pathCompleteNum:`_pathCompleteNum_u0u8l_144`,pathCompleteSub:`_pathCompleteSub_u0u8l_145`,subtitleLink:`_subtitleLink_u0u8l_147`,sheetLink:`_sheetLink_u0u8l_153`,addPuzzleBtn:`_addPuzzleBtn_u0u8l_160`,confirmButtons:`_confirmButtons_u0u8l_173`,confirmYes:`_confirmYes_u0u8l_178`,confirmNo:`_confirmNo_u0u8l_189`,levelHeader:`_levelHeader_u0u8l_202`,levelLabel:`_levelLabel_u0u8l_210`,loadingLabel:`_loadingLabel_u0u8l_211`,bottomNav:`_bottomNav_u0u8l_214`,resetBtn:`_resetBtn_u0u8l_220`,levelTitle:`_levelTitle_u0u8l_233`,nodes:`_nodes_u0u8l_243`,node:`_node_u0u8l_243`,nodeUnpuzzled:`_nodeUnpuzzled_u0u8l_267`,nodePuzzled:`_nodePuzzled_u0u8l_268`,terminalNode:`_terminalNode_u0u8l_272`,childCount:`_childCount_u0u8l_275`,depthBadge:`_depthBadge_u0u8l_283`,backButton:`_backButton_u0u8l_293`,stats:`_stats_u0u8l_305`,treeViewport:`_treeViewport_u0u8l_318`,treeRoot:`_treeRoot_u0u8l_324`,treeItem:`_treeItem_u0u8l_334`,treeChildren:`_treeChildren_u0u8l_378`,treeNodeBox:`_treeNodeBox_u0u8l_400`,treeExpandedBox:`_treeExpandedBox_u0u8l_425`,treeTerminalBox:`_treeTerminalBox_u0u8l_431`,treeWord:`_treeWord_u0u8l_445`,puzzleBadge:`_puzzleBadge_u0u8l_450`},de=new Map(y.map((e,t)=>[e.sixLetter,t+1])),fe=`/AlphaDelta/`.replace(/\/$/,``);async function pe(e){let t=e.length?e.join(`/`)+`/`:``,n=await fetch(`${fe}/puzzle-tree/${t}index.json`);if(!n.ok)throw Error(`${n.status} loading ${t}index.json`);return n.json()}function me(e,t,n){if(t.length===0)return{...e,...n};let[r,...i]=t;return{...e,children:{...e.children??{},[r]:me(e.children?.[r]??{},i,n)}}}function D(e,t){let n=e;for(let e of t){if(!n?.children?.[e])return null;n=n.children[e]}return n}var O=`https://docs.google.com/spreadsheets/d/1gPJKU-mlP6L_JljXvJFwxGOXSmJOpklTblGG1jfTq08/export?format=csv&gid=1881712769`,he=`https://docs.google.com/forms/d/e/1FAIpQLScZGMw_adTq13FTOR21Tx46wy4LPZczpzsxQYoXhSNP3FRpAA/formResponse`,ge={6:`entry.286261207`,5:`entry.48461877`,4:`entry.1189278412`,3:`entry.215585409`,2:`entry.973779032`,1:`entry.1514953076`};async function _e(e){let t=new URLSearchParams;e.forEach(e=>t.append(ge[e.length],e)),await fetch(he,{method:`POST`,mode:`no-cors`,body:t})}function ve(){let[e,t]=(0,_.useState)(null),[n,r]=(0,_.useState)([]),[i,a]=(0,_.useState)(!0),[o,s]=(0,_.useState)(null),[c,l]=(0,_.useState)(!1),[u,d]=(0,_.useState)(!1),[f,p]=(0,_.useState)(0),[m,h]=(0,_.useState)(null);(0,_.useEffect)(()=>{pe([]).then(e=>{t(e),a(!1)}).catch(e=>{s(e.message),a(!1)})},[]),(0,_.useEffect)(()=>{n.length===6&&window.gtag?.(`event`,`tree_path_completed`,{puzzle_word:n[5],already_puzzle:!!de.get(n[5])})},[n]),(0,_.useEffect)(()=>{fetch(O).then(e=>e.text()).then(e=>{h(new Set(e.trim().split(`
`).slice(1).map(e=>e.split(`,`)[1]?.replace(/"/g,``).trim().toUpperCase()).filter(Boolean)))}).catch(()=>h(new Set))},[]);async function g(i,o=!1){let c=[...n,i];if(l(!1),d(!1),o){r(c);return}if(D(e,c)?.children!==void 0){r(c);return}a(!0);try{let e=await pe(c);t(t=>me(t,c,e)),r(c)}catch(e){s(e.message)}finally{a(!1)}}if(!e&&i)return(0,x.jsx)(`div`,{className:E.container,children:(0,x.jsx)(`p`,{children:`Loading puzzle tree…`})});if(o)return(0,x.jsx)(`div`,{className:E.container,children:(0,x.jsx)(`p`,{className:E.error,children:o})});let v=(D(e,n)??e)?.children??{},b=Object.entries(v).filter(([e,t])=>e.length+t.maxDepth>=6).sort(([e],[t])=>e.localeCompare(t));return(0,x.jsx)(`div`,{className:E.container,children:(0,x.jsxs)(`div`,{className:E.dagView,children:[(0,x.jsxs)(`div`,{className:E.scrollArea,children:[(0,x.jsx)(`h1`,{className:E.title,children:`Puzzle Tree`}),(0,x.jsxs)(`p`,{className:E.subtitle,children:[`Build a new puzzle from the bottom up and submit it to be added to the game.`,(0,x.jsx)(`br`,{}),`See open submissions `,(0,x.jsx)(`a`,{className:E.subtitleLink,href:`https://docs.google.com/spreadsheets/d/1gPJKU-mlP6L_JljXvJFwxGOXSmJOpklTblGG1jfTq08/edit?gid=1881712769`,target:`_blank`,rel:`noreferrer`,children:`here`}),`.`]}),n.length>0&&(0,x.jsx)(`div`,{className:E.pathStack,children:[...n].reverse().map((e,t)=>{let i=n.length-1-t,a=e.length===6;return(0,x.jsx)(`button`,{className:`${E.pathWord} ${a?E.pathWordFinal:``}`,onClick:()=>r(n.slice(0,i+1)),children:e},e)})}),n.length<6&&(0,x.jsxs)(`div`,{className:E.levelHeader,children:[(0,x.jsxs)(`span`,{className:E.levelLabel,children:[n.length+1,`-letter words`]}),i&&(0,x.jsx)(`span`,{className:E.loadingLabel,children:`Loading…`})]}),n.length===6?(0,x.jsx)(`div`,{className:E.pathComplete,children:de.get(n[5])?(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{className:E.pathCompleteTitle,children:`Already a puzzle`}),(0,x.jsxs)(`div`,{className:E.pathCompleteNum,children:[`Puzzle #`,de.get(n[5])]})]}):m?.has(n[5])?(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{className:E.pathCompleteTitle,children:`Already queued`}),(0,x.jsx)(`div`,{className:E.pathCompleteSub,children:`This puzzle has been submitted and will be added on the next import run`}),(0,x.jsx)(`a`,{className:E.sheetLink,href:`https://docs.google.com/spreadsheets/d/1gPJKU-mlP6L_JljXvJFwxGOXSmJOpklTblGG1jfTq08/edit?gid=1881712769`,target:`_blank`,rel:`noreferrer`,children:`View queue`})]}):u?(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{className:E.pathCompleteTitle,children:`Submitted!`}),(0,x.jsxs)(`div`,{className:E.pathCompleteSub,children:[`It'll be Puzzle #`,y.length+f,` — live on the next import run`]}),(0,x.jsx)(`a`,{className:E.sheetLink,href:`https://docs.google.com/spreadsheets/d/1gPJKU-mlP6L_JljXvJFwxGOXSmJOpklTblGG1jfTq08/edit?gid=1881712769`,target:`_blank`,rel:`noreferrer`,children:`View queue`})]}):c?(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{className:E.pathCompleteTitle,children:`Add this puzzle?`}),(0,x.jsx)(`div`,{className:E.pathCompleteSub,children:n.join(` → `)}),(0,x.jsxs)(`div`,{className:E.confirmButtons,children:[(0,x.jsx)(`button`,{className:E.confirmYes,onClick:async()=>{await _e(n),window.gtag?.(`event`,`puzzle_submitted`,{puzzle_word:n[5]}),p(e=>e+1),l(!1),d(!0)},children:`Yes, add it`}),(0,x.jsx)(`button`,{className:E.confirmNo,onClick:()=>l(!1),children:`Cancel`})]})]}):(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`div`,{className:E.pathCompleteTitle,children:`New puzzle candidate`}),(0,x.jsx)(`div`,{className:E.pathCompleteSub,children:n.join(` → `)}),(0,x.jsx)(`button`,{className:E.addPuzzleBtn,onClick:()=>l(!0),children:`Add Puzzle`})]})}):(0,x.jsx)(`div`,{className:E.nodes,children:b.map(([e,t])=>{let n=t.maxDepth===0,r=de.get(e),i=n?!!r:!t.hasUnpuzzled;return(0,x.jsxs)(`div`,{className:`${E.node} ${n?E.terminalNode:``} ${i?E.nodePuzzled:E.nodeUnpuzzled}`,onClick:()=>g(e,n),children:[(0,x.jsx)(`span`,{children:e}),n&&(0,x.jsx)(`div`,{className:E.depthBadge,children:`end`}),!n&&t.childCount!==void 0&&(0,x.jsx)(`div`,{className:E.childCount,children:t.childCount}),r&&(0,x.jsxs)(`div`,{className:E.puzzleBadge,children:[`Puzzle #`,r]})]},e)})})]}),(0,x.jsxs)(`div`,{className:E.bottomBar,children:[n.length>0&&(0,x.jsx)(`button`,{className:E.backButton,onClick:()=>r(e=>e.slice(0,-1)),children:`← Back`}),n.length>1&&(0,x.jsx)(`button`,{className:E.resetBtn,onClick:()=>r([]),children:`Reset`}),(0,x.jsx)(`span`,{className:E.bottomSpacer}),(0,x.jsx)(`span`,{className:E.legendDot,style:{background:`#81c784`}}),(0,x.jsx)(`span`,{className:E.legendText,children:`unpuzzled`}),(0,x.jsx)(`span`,{className:E.legendSep}),(0,x.jsx)(`span`,{className:E.legendDot,style:{background:`#ffb347`}}),(0,x.jsx)(`span`,{className:E.legendText,children:`puzzled`})]})]})})}var ye=Date.UTC(2024,0,1);function be(){return`/AlphaDelta/`}function xe(e){let t=new Date,n=Date.UTC(t.getUTCFullYear(),t.getUTCMonth(),t.getUTCDate());return(Math.floor((n-ye)/864e5)%e+e)%e}function Se(e,t=be()){let n=t.replace(/\/$/,``);if(n&&n!==``&&e.startsWith(n)){let t=e.slice(n.length);return t.startsWith(`/`)?t:`/${t}`}return e}function Ce(e,t=be()){let n=Se(e,t);return n===`/menu`||n===`/menu/`}function we(e,t,n=be()){let r=Se(e,n);if(Ce(e,n)||r===`/`||r===``)return xe(t);let i=r.match(/^\/(\d+)\/?$/);if(i){let e=parseInt(i[1],10);return Math.min(Math.max(e-1,0),t-1)}return xe(t)}function Te(e,t=be()){return`${t}${e+1}`.replace(/([^:]\/)\/+/g,`$1`)}function Ee(e){let t=Te(e);window.history.pushState({puzzleIndex:e},``,t)}function De(e,t=be()){let n=Se(e,t);return n===`/tree`||n===`/tree/`}function Oe(){let[e,t]=(0,_.useState)(()=>Ce(window.location.pathname)),[n,r]=(0,_.useState)(()=>De(window.location.pathname)),[i,a]=(0,_.useState)(()=>we(window.location.pathname,y.length)),[o,s]=(0,_.useState)(()=>{let e=localStorage.getItem(`wordGameStats`),t=e?JSON.parse(e):[];return y.map((e,n)=>t[n]||{id:n,status:`unsolved`,attempts:0,solved:!1})});(0,_.useEffect)(()=>{localStorage.setItem(`wordGameStats`,JSON.stringify(o))},[o]),(0,_.useEffect)(()=>{let e=()=>{t(Ce(window.location.pathname)),r(De(window.location.pathname)),a(we(window.location.pathname,y.length))};return window.addEventListener(`popstate`,e),()=>window.removeEventListener(`popstate`,e)},[]),(0,_.useEffect)(()=>{n?window.gtag?.(`event`,`page_view`,{page_title:`Puzzle Tree`,page_path:`/tree`}):e?window.gtag?.(`event`,`page_view`,{page_title:`Menu`,page_path:`/menu`}):window.gtag?.(`event`,`page_view`,{page_title:`Puzzle #${i+1}`,page_path:`/puzzle/${i+1}`})},[n,e,i]);let c=(0,_.useCallback)(e=>{let n=Math.min(Math.max(e,0),y.length-1);Ee(n),t(!1),a(n),window.gtag?.(`event`,`puzzle_selected`,{puzzle_index:n+1,puzzle_word:y[n].sixLetter})},[]),l=()=>{c((i+1)%y.length)},u=()=>{s(e=>{let t=[...e];return t[i]={...t[i],status:`solved`,solved:!0,attempts:(t[i].attempts||0)+1},t})},d=()=>{s(e=>{let t=[...e];return t[i]={...t[i],status:`gaveup`,attempts:(t[i].attempts||0)+1},t})},f=o.filter(e=>e.solved).length,p=o.filter(e=>e.status===`gaveup`).length;return n?(0,x.jsx)(ve,{}):e?(0,x.jsx)(ee,{puzzles:y,stats:o,onSelectPuzzle:c,solvedCount:f,gaveUpCount:p}):(0,x.jsx)(T,{puzzle:y[i],puzzleIndex:i,onSolved:u,onGaveUp:d,onNextPuzzle:l,totalPuzzles:y.length},i)}v.createRoot(document.getElementById(`root`)).render((0,x.jsx)(_.StrictMode,{children:(0,x.jsx)(Oe,{})}));