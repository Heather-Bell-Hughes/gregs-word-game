...
zwieback
zygote
zygotes`,x=null;function ee(){return x||=new Set(b.split(`
`).map(e=>e.trim().toUpperCase()).filter(e=>e.length>0)),x}function S(e){return ee().has(e.toUpperCase())}function C(e,t){return e.padEnd(t,`_`).slice(0,t).split(``)}function te(e){let t=e.join(``);return t.replace(/_/g,``)?(t.startsWith(`_`)||/_[A-Z]/.test(t),t.replace(/_+$/,``)):``}function ne(e,t,n,r){let i=C(e,t);return i[n]=r,te(i)}function re(e,t,n){let r=C(e,t),i=n;if(i===null){for(let e=t-1;e>=0;e--)if(r[e]!==`_`){i=e;break}if(i===null)return e}return i<0||i>=t||r[i]===`_`?e:(r[i]=`_`,te(r))}function w(e,t){return C(e,t).indexOf(`_`)}function ie(e,t){return C(e,t).every(e=>e!==`_`)}var ae=[5,4,3,2,1];function oe(e,t,n=null,r=null){let i=new Set(t.split(``));for(let t of ae){let a=C(e[t]||``,t);for(let e=0;e<t;e++){let o=a[e];o!==`_`&&(t===n&&e===r||i.add(o))}}return i}var se=o((e=>{var t=Symbol.for(`react.transitional.element`);function n(e,n,r){var i=null;if(r!==void 0&&(i=``+r),n.key!==void 0&&(i=``+n.key),`key`in n)for(var a in r={},n)a!==`key`&&(r[a]=n[a]);else r=n;return n=r.ref,{$$typeof:t,type:e,key:i,ref:n===void 0?null:n,props:r}}e.jsx=n,e.jsxs=n})),T=o(((e,t)=>{t.exports=se()}))(),ce=[[`Q`,`W`,`E`,`R`,`T`,`Y`,`U`,`I`,`O`,`P`],[`A`,`S`,`D`,`F`,`G`,`H`,`J`,`K`,`L`],[`Z`,`X`,`C`,`V`,`B`,`N`,`M`,`DEL`]];function E({puzzle:e,puzzleIndex:t,onSolved:n,onGaveUp:r,onNextPuzzle:i,totalPuzzles:a}){let[o,s]=(0,_.useState)({5:``,4:``,3:``,2:``,1:``}),[c,l]=(0,_.useState)(5),[u,d]=(0,_.useState)(null),f=e.sixLetter,[p,m]=(0,_.useState)(``),[h,g]=(0,_.useState)(!1),[v,y]=(0,_.useState)({}),[b,x]=(0,_.useState)(!1),[ee,te]=(0,_.useState)(!1),se=(0,_.useRef)(5),E=(0,_.useRef)(null),D=(0,_.useRef)({5:``,4:``,3:``,2:``,1:``});(0,_.useEffect)(()=>{se.current=c},[c]),(0,_.useEffect)(()=>{E.current=u},[u]),(0,_.useEffect)(()=>{D.current=o},[o]);let O=(0,_.useCallback)((e,t)=>{if(!ie(t,e)||!S(t.replace(/_/g,``)))return;let n=ae.indexOf(e);if(n>=ae.length-1)return;let r=ae[n+1];se.current=r,E.current=0,l(r),d(0)},[]),le=(0,_.useCallback)(()=>{let e=se.current,t=D.current[e],n=E.current;if(n===null&&ie(t,e)&&S(t.replace(/_/g,``))){let r=ae.indexOf(e);r<ae.length-1&&(e=ae[r+1],t=D.current[e],n=0)}return{wordSize:e,word:t,boxIndex:n}},[]),ue=(0,_.useCallback)((e,t)=>{if(ie(t,e)){let n=S(t.replace(/_/g,``));y(r=>({...r,[e]:C(t,e).map(()=>n?`correct`:`wrong`)}))}else y(t=>({...t,[e]:[]}))},[]),de=(0,_.useMemo)(()=>oe(o,f,u===null?null:c,u),[o,f,c,u]),fe=(0,_.useCallback)(e=>{let{wordSize:t,word:n,boxIndex:r}=le();if(oe(D.current,f,r===null?null:t,r).has(e))return;t!==se.current&&(se.current=t,E.current=r??0,l(t),d(r??0));let i=C(n,t);if(r!==null&&r<t&&i[r]===e){let e=r+1;e<t&&(E.current=e,d(e));return}let a=null;if(r!==null&&r<t){a=ne(n,t,r,e),s(e=>({...e,[t]:a}));let i=r+1;i<t&&(E.current=i,d(i))}else{let r=w(n,t);r!==-1&&(a=ne(n,t,r,e),s(e=>({...e,[t]:a})))}a!==null&&(ue(t,a),O(t,a))},[f,le,O,ue]),k=(0,_.useCallback)(e=>{fe(e)},[fe]),A=(0,_.useCallback)((e,t)=>{se.current=e,E.current=t,l(e),d(t)},[]),pe=(e,t)=>{A(e,t)},me=e=>{let t=D.current[e];if(se.current=e,l(e),t.replace(/_/g,``).length===0)E.current=0,d(0);else{let n=C(t,e).findLastIndex(e=>e!==`_`);n===-1&&(n=0),E.current=n,d(n)}},he=(0,_.useCallback)((e,t)=>{let n=D.current[e],r=C(n,e),i=t;if(i===null&&(i=r.findLastIndex(e=>e!==`_`),i===-1&&(i=0)),r[i]!==`_`){let t=re(n,e,i);t!==n&&(s(n=>({...n,[e]:t})),ue(e,t))}A(e,Math.max(0,i-1))},[ue,A]),ge=(0,_.useCallback)(e=>{let t=se.current,n=E.current,r=D.current[t],i=C(r,t);n=n===null?e===`left`?i.findLastIndex(e=>e!==`_`)===-1?0:i.findLastIndex(e=>e!==`_`):0:e===`left`?Math.max(0,n-1):Math.min(t-1,n+1),A(t,n)},[A]),_e=(0,_.useCallback)(()=>{he(se.current,E.current)},[he]);(0,_.useEffect)(()=>{let e=e=>{if(e.ctrlKey||e.metaKey)return;let t=e.key.toUpperCase();/^[A-Z]$/.test(t)?(e.preventDefault(),fe(t)):e.key===`ArrowLeft`?(e.preventDefault(),ge(`left`)):e.key===`ArrowRight`?(e.preventDefault(),ge(`right`)):e.key===`Backspace`&&(e.preventDefault(),he(se.current,E.current))};return document.addEventListener(`keydown`,e),()=>document.removeEventListener(`keydown`,e)},[fe,he,ge]),(0,_.useEffect)(()=>{let e=!0,t=!0,r={};for(let n of[5,4,3,2,1]){let i=o[n],a=i.replace(/_/g,``);if(r[n]=[],ie(i,n)||(e=!1),ie(i,n)){let e=S(a);for(let t=0;t<n;t++)r[n][t]=e?`correct`:`wrong`;e||(t=!1)}}y(r),e&&t&&!ee&&!b&&(te(!0),m(`🎉 Congratulations, Well Done!`),n())},[o,ee,b,n]);let ve=()=>{x(!0),s({5:e.fiveLetters,4:e.fourLetters,3:e.threeLetters,2:e.twoLetters,1:e.oneLetter});let t={};for(let e of[5,4,3,2,1])t[e]=Array(e).fill(`correct`);y(t),r()},ye=()=>{s({5:``,4:``,3:``,2:``,1:``}),m(``),y({}),l(5),d(0),x(!1),te(!1)};return(0,T.jsxs)(`div`,{className:`container`,"data-testid":`game-screen`,children:[p&&(0,T.jsx)(`div`,{className:`message ${p.includes(`✓`)||p.includes(`🎉`)?`success`:`error`}`,children:p}),(0,T.jsxs)(`div`,{className:`header`,children:[(0,T.jsx)(`div`,{className:`header-spacer`,"aria-hidden":`true`}),(0,T.jsxs)(`div`,{className:`puzzle-title`,children:[`AlphaDelta #`,t+1]}),(0,T.jsx)(`button`,{className:`info-btn`,onClick:()=>g(!h),children:`?`})]}),h&&(0,T.jsx)(`div`,{className:`rules-modal`,children:(0,T.jsxs)(`div`,{className:`rules-content`,children:[(0,T.jsx)(`h2`,{children:`How to Play`}),(0,T.jsx)(`p`,{children:`When the game starts, a 6-letter word will appear from an A-Z alphabet. Using the remaining letters of the alphabet, make a 5-letter word, a 4-letter word, a 3-letter word, a 2-letter word & a 1-letter word in the boxes. Each alphabet letter can only be used once. All valid words are regular everyday english words.`}),(0,T.jsx)(`button`,{className:`btn`,onClick:()=>g(!1),children:`Close`})]})}),(0,T.jsxs)(`div`,{className:`buttons-row`,children:[b||ee?(0,T.jsx)(`button`,{className:`btn reveal`,onClick:i,children:`New Game`}):(0,T.jsx)(`button`,{className:`btn reveal`,onClick:ve,children:`Solution`}),!ee&&!b&&(0,T.jsx)(`button`,{className:`btn`,"data-testid":`clear-btn`,onClick:()=>{s(e=>({...e,[c]:``})),y(e=>({...e,[c]:[]})),E.current=0,d(0)},children:`Clear`}),!ee&&!b&&(0,T.jsx)(`button`,{className:`btn restart`,"data-testid":`restart-btn`,onClick:()=>{confirm(`Are you sure you want to restart the puzzle?`)&&ye()},children:`Restart`})]}),(0,T.jsxs)(`div`,{className:`puzzle-area`,children:[(0,T.jsxs)(`div`,{className:`word-boxes-container`,children:[(0,T.jsx)(`div`,{className:`word-row six-letter-row`,"data-testid":`six-letter-row`,children:e.sixLetter.split(``).map((e,t)=>(0,T.jsx)(`div`,{className:`letter-box`,children:e},t))}),[5,4,3,2,1].map(e=>{let t=C(o[e],e);return(0,T.jsx)(`div`,{className:`word-row`,"data-word-size":e,"data-testid":`word-row-${e}`,onClick:()=>me(e),children:t.map((t,n)=>(0,T.jsx)(`button`,{type:`button`,"data-testid":`word-box-${e}-${n}`,"aria-label":`${e}-letter word, position ${n+1}${t===`_`?`, empty`:`, letter ${t}`}${c===e&&u===n?`, selected`:``}`,className:`word-box ${t===`_`?`empty`:`filled`} ${c===e&&u===n?`focused`:c===e?`selected`:``} ${v[e]?.[n]?v[e][n]:``}`,onClick:t=>{t.stopPropagation(),pe(e,n)},onTouchEnd:t=>{t.stopPropagation(),t.preventDefault(),pe(e,n)},children:t===`_`?``:t},n))},e)})]}),(0,T.jsx)(`div`,{className:`keyboard-container`,"data-testid":`keyboard`,children:ce.map((e,t)=>(0,T.jsx)(`div`,{className:`keyboard-row`,children:e.map((e,t)=>e===``?(0,T.jsx)(`div`,{className:`keyboard-spacer`},t):e===`DEL`?(0,T.jsx)(`button`,{type:`button`,"data-testid":`keyboard-delete`,className:`keyboard-key delete-key`,onClick:_e,onTouchEnd:e=>{e.preventDefault(),_e()},children:`⌫`},e):(0,T.jsx)(`button`,{type:`button`,"data-testid":`keyboard-key-${e}`,className:`keyboard-key ${de.has(e)?`used`:``}`,onClick:()=>k(e),onTouchEnd:t=>{t.preventDefault(),k(e)},children:e},e))},t))})]})]})}var D=Date.UTC(2024,0,1);function O(){return`/gregs-word-game/`}function le(e){let t=new Date,n=Date.UTC(t.getUTCFullYear(),t.getUTCMonth(),t.getUTCDate());return(Math.floor((n-D)/864e5)%e+e)%e}function ue(e,t=O()){let n=t.replace(/\/$/,``);if(n&&n!==``&&e.startsWith(n)){let t=e.slice(n.length);return t.startsWith(`/`)?t:`/${t}`}return e}function de(e,t,n=O()){let r=ue(e,n);if(r===`/`||r===``)return le(t);let i=r.match(/^\/(\d+)\/?$/);if(i){let e=parseInt(i[1],10);return Math.min(Math.max(e-1,0),t-1)}return le(t)}function fe(e,t=O()){return`${t}${e+1}`.replace(/([^:]\/)\/+/g,`$1`)}function k(e){let t=fe(e);window.history.pushState({puzzleIndex:e},``,t)}function A(){let[e,t]=(0,_.useState)(()=>de(window.location.pathname,y.length)),[n,r]=(0,_.useState)(()=>{let e=localStorage.getItem(`wordGameStats`),t=e?JSON.parse(e):[];return y.map((e,n)=>t[n]||{id:n,status:`unsolved`,attempts:0,solved:!1})});(0,_.useEffect)(()=>{localStorage.setItem(`wordGameStats`,JSON.stringify(n))},[n]),(0,_.useEffect)(()=>{let e=()=>{t(de(window.location.pathname,y.length))};return window.addEventListener(`popstate`,e),()=>window.removeEventListener(`popstate`,e)},[]);let i=(0,_.useCallback)(e=>{let n=Math.min(Math.max(e,0),y.length-1);k(n),t(n)},[]);return(0,T.jsx)(E,{puzzle:y[e],puzzleIndex:e,onSolved:()=>{r(t=>{let n=[...t];return n[e]={...n[e],status:`solved`,solved:!0,attempts:(n[e].attempts||0)+1},n})},onGaveUp:()=>{r(t=>{let n=[...t];return n[e]={...n[e],status:`gaveup`,attempts:(n[e].attempts||0)+1},n})},onNextPuzzle:()=>{i((e+1)%y.length)},totalPuzzles:y.length},e)}v.createRoot(document.getElementById(`root`)).render((0,T.jsx)(_.StrictMode,{children:(0,T.jsx)(A,{})}));